            ...
            <div class="block-header">
                <div class="row">
                    <div class="col-lg-6 col-md-8 col-sm-12">
                        <h2><a href="javascript:void(0);" class="btn btn-xs btn-link btn-toggle-fullwidth"><i class="fa fa-arrow-left"></i></a>Edit Album</h2>
                        <ul class="breadcrumb">
                                    ...
                                    <div class="col-lg-12 col-md-12">
                                        <div class="form-group">
                                            <div class="mb-3">
                                                ...
                                                <input type="file" class="form-control" id="pictures" name="pictures" value="{{$album->pictures}}">
                                            </div>
                                        </div>
                                    </div>
                                </div>
